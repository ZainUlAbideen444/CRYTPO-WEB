...
import {
  ...
  Briefcase, Clock, BarChart2, ChevronLeft,
...
export default function Sidebar({ onLogout }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-white/5">
        ...
        {!collapsed && (
          <div>
            ...
            <div className="font-display text-xs font-bold text-red-500 leading-none mt-0.5">SIM</div>
          </div>
        )}
      </div>
      ...
      {/* Bottom */}
      <div className="px-2 pb-4 border-t border-white/5 pt-4 flex flex-col gap-1">
        <button
          onClick={onLogout}
          className={`sidebar-link hover:text-red-400 ${collapsed ? 'justify-center' : ''}`}
        >
